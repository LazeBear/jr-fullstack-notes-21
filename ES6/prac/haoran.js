...
//     const taxLevel = {
//         'Electornics': {additionalTax: 0.08, importedTax:0.15},
//         'Clothing': {additionalTax: 0.05, importedTax:0.1},
//         'Books': {additionalTax: 0.05, importedTax:0.1},
//         'Others': {additionalTax: 0.05, importedTax:0.1}
//     }
//     const taxInfo = taxLevel[category] || {additionalTax: 0, importedTax: 0}
//     let totalTaxRate = 0.1
//     totalTaxRate += taxInfo.additionalTax
//     totalTaxRate += isImported ? taxInfo.importedTax : 0
...
//   try {
//     const data = await mockAPIRequest2();
//     console.log(data);
//   } catch (error) {
//     console.log(error);
//   }
...
//     array.forEach((item) => newSet.add(item));
//   }
//   return [...newSet];
// };
...
//     print: () => {
//       console.log(
//         `The price for the book <${title}> written by 'Author ${author}' is ${price}`
//       );
//     },
//   };
//   return newObject;
// };
// createBook('111', '222', '333').print();
